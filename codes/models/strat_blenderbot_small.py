...
class Model(BaseModel, BlenderbotSmallForConditionalGeneration):
    ...
    def generate(
        ...
        kwargs.pop('other_res', None)
        kwargs.pop('pred_strat_id', None)
        kwargs.pop('pred_strat_id_top1', None)
        kwargs.pop('pred_strat_id_top3', None)
        kwargs.pop('pred_strat_id_dist', None)
        # -------------------------
