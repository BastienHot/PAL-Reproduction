...
# CHANGE: added argparse to replace hardcoded path (was: /home/chengjiale/emotion/MISC/generated_data/all_loss/hyp_strategy.json)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, required=True,
                        help='Path to gen.json or hyp_strategy.json')
