...
# CHANGE: removed dead import `from utils import top_k_top_p_filtering`
# The original repo's utils.py was never uploaded (see GitHub issue #8).
# The function is never called in this file anyway.
import math
import random
import re
import argparse
...
def main():
    ...
    trainer = pl.Trainer(
        ...
        min_epochs=1,
        default_root_dir='./pl_root'  # CHANGE: was hardcoded to /home/chengjiale/emotion/Persona_extractor/pl_root
    )
...
if __name__ == '__main__':
    ...
    hparams.train_dir = './data'  # CHANGE: was hardcoded to /home/chengjiale/emotion/Persona_extractor/data/both_original
